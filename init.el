...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons all-the-icons-dired company compile-multi
		   ...
		   go-tag godoctor gruvbox-theme kaolin-themes
		   key-quiz lsp-mode lsp-treemacs lsp-ui magit
		   marginalia meow nerd-icons orderless popper
		   rainbow-delimiters treemacs-icons-dired vertico
		   vscode-icon vterm vterm-toggle which-key yasnippet)))
